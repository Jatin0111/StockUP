...
st.markdown('##### -  One can gain information of all the stocks that are listed on National Stock Exchange (NSE) (To Be Exact - 1964 Companies). ')
...
st.markdown('#####  - All the historical prices for stocks for last 10 years are taken from Yahoo Finance.')
st.markdown('##### - Prices of stocks are in realtime.')
st.divider()
...
st.markdown(' ##### -  This feature provides all the top news related to stock and a button to read full article.')
